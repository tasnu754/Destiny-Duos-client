...
const Team = () => {
    return (
      <div className="my-10">
        <h1 className="text-5xl text-center font-bold py-10 text-yellow-900">
          Customers Review
        </h1>
        <div className="md:flex justify-around gap-4 ">
          <div className="mb-6 relative grid h-[40rem] w-full max-w-[28rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="relative p-6 px-6 py-14 md:px-12">
              <h2 className="mb-6 block font-sans text-2xl font-medium leading-[1.5] tracking-normal text-white antialiased">
                I absolutely adore the trendy service this store offers. The
                ideas fit so well
              </h2>
          ...
          <div className="mb-6 relative grid h-[40rem] w-full max-w-[28rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="relative p-6 px-6 py-14 md:px-12">
              <h2 className="mb-6 block font-sans text-2xl font-medium leading-[1.5] tracking-normal text-white antialiased">
                Great service, Great Ideas and FAST response!!I just got my
                first connection and I have one word WOW!!!!
              </h2>
              <h5 className="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-400">
                John Deo
              </h5>
          ...
          <div className="mb-6 relative grid h-[40rem] w-full max-w-[28rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            ...
            <div className="relative p-6 px-6 py-14 md:px-12">
              <h2 className="mb-6 block font-sans text-2xl font-medium leading-[1.5] tracking-normal text-white antialiased">
                Full-figured and Fabulous indeed! I just got my partner and I LOVE
                everything!
              </h2>
              <h5 className="block mb-4 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-gray-400">
                Andrew
